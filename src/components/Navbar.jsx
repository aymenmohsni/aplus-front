      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {!user && (
              <Link to="/register" className="text-secondary hover:text-secondary/80 font-semibold transition-colors flex items-center gap-1">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-2">
                <Link to="/login" className="px-4 py-2 text-primary hover:text-primary/80 font-semibold transition-colors">Login</Link>
