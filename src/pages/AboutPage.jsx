...
const AboutPage = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-medical-mint via-white to-primary/5 py-20 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {founders.map((founder) => (
              <div key={founder.name} className="glass-card p-8 animate-slide-up group hover:shadow-xl transition-shadow duration-300">
                {/* Avatar */}
                <div className={`w-20 h-20 bg-gradient-to-br ${founder.gradient} rounded-2xl flex items-center justify-center mb-6 shadow-lg`}>
      ...
      <section className="bg-gradient-to-r from-primary to-secondary py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/products"
              className="px-8 py-4 bg-white text-primary font-semibold rounded-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200"
            >
              Browse Products
            </Link>
            <Link
              to="/register"
              className="px-8 py-4 bg-white/10 border-2 border-white text-white font-semibold rounded-lg hover:bg-white/20 transition-all duration-200 flex items-center justify-center gap-2"
            >
