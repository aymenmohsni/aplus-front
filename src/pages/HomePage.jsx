...
const HomePage = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-medical-mint to-white">
      {/* Hero Section */}
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              {!user && (
                <Link
                  to="/register"
                  className="px-6 py-3 bg-white text-primary font-semibold rounded-lg border-2 border-primary 
                           hover:bg-primary hover:text-white transition-all duration-200 text-center"
                >
                  Create Account
                </Link>
              )}
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-display text-4xl text-neutral mb-4">Why Choose APlusMed?</h2>
