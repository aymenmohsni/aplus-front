...
const ComingSoonPage = () => {
  ...
  const CountdownUnit = ({ value, label }) => (
    <div className="flex flex-col items-center">
      <div className="relative">
        ...
        {/* Accent dot */}
        <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-br from-primary to-secondary rounded-full" />
      </div>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-medical-mint via-white to-primary/5 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(circle, #0ea5e920 1px, transparent 1px)`,
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center px-6 py-12 text-center">
        ...
        >
          ...
          <span
            ...
            style={{ backgroundImage: 'linear-gradient(to right, #0ea5e9, #00b4a8)' }}
          >
            Supplies Hub
          </span>{' '}
          Is Almost Here
